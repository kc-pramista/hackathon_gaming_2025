...
class Button:
    def __init__(self, surface, color, pos_x, pos_y, radius, name, price):
    ...
    def draw(self):
        ...
        priceText = font.render(str(self.price), True, (220, 220, 220))
        self.surface.blit(priceText, (self.pos_x - self.radius + 20, self.pos_y - self.radius / 2 + 40))
